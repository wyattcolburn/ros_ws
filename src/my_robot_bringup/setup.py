...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/launch', ['launch/turtlebot4_ignition.launch.py', 'launch/ros_ign_bridge.launch.py', 'launch/sample_world.launch.py', 'launch/turtlebot4_nodes.launch.py', 'launch/basic_world.launch.py','launch/test_dependecies.launch.py', 'launch/turtlebot4_spawn.launch.py']),
    ],
