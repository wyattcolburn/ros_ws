...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'sym_noise=my_robot_bringup.multiple_old_noisy_obs:main',
            ...
            'barn_nodock_old= my_robot_bringup.barn_nodock_old:main',
