...
def main(args=None):
    ...
    parser.add_argument("--speed", type=float, default=.5,
                        help="--interval, publishing freq")
    parser.add_argument("--type", type=str,
                        default='interval', help="type of movement")
    parser.add_argument("--v_steps", type=int, default=8,
                        help="intervals for v")
    parser.add_argument("--w_steps", type=int, default=10,
                        help="intervals for w")
...
# Create and spin the node
    random_motor_node = randomMotor(
        parsed_args.speed, parsed_args.type, parsed_args.v_steps, parsed_args.w_steps)
