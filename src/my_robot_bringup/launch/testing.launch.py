...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('input_dkr', default_value='/home/wyattcolburn/ros_ws/utils/ten_thou/',
                          description='where to get cmd vel from')
]
...
def generate_launch_description():
    ...
    undock_node = TimerAction(
        ...
        executable='test_undock_node',  # You need to create this
        output='screen')]

    )
    print("**********************************************************88*********************************************************")
    print("input_dkr:", LaunchConfiguration('input_dkr'))
