...
launch_terminal "ros2 launch turtlebot4_ignition_bringup turtlebot4_ignition.launch.py"
...
launch_terminal "ros2 launch turtlebot4_navigation localization.launch.py map:=/home/wyattcolburn/ros_ws/big_map_april_4.yaml use_sim_time:=true"
...
launch_terminal "ros2 launch turtlebot4_navigation nav2.launch.py use_sim_time:=true"
